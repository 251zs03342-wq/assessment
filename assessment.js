...
const answers = [
  '###userName###のいいところは声です。###userNae###の特徴的な声は皆を惹きつけ、心に残ります。',
...
//   // 太郎
//   console.log('太郎');
//   console.assert(assessment('太郎') === '太郎のいいは決断力です。太郎がする決断にいつも助けられる人がいます。','診断結果の文言の特定の部分を名まえに置き換える処理が正しくありません。');

// // 次郎
// console.log('次郎');
// console.assert(assessment('次郎') === '次郎のいいは自制心です。やばいと思ったときにしっかりと衝動を抑えられる次郎が皆から評価されています。','診断結果の文言の特定の部分を名前に置き換える処理が正しくありません。');
